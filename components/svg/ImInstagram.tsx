...
const ImInstagram = (props: any) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={144} height={144} viewBox="0 0 48 48" {...props}>
    ...
    />
    <radialGradient id="b" cx={11.786} cy={5.54} r={29.813} gradientTransform="matrix(1 0 0 .6663 0 1.849)" gradientUnits="userSpaceOnUse">
